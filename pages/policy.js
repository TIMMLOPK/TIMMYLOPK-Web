  ...
  return (
    <Layout>
      ...
      <p>
        ...
        not employ or manage.This privacy policy was created with the help of
        the{' '}
        <NextLink
          target="_blank"
      ...
      <p>
        ...
        web page server.Cookies cannot be used to run programs or deliver
      ...
      <p>
        ...
        revise the updated date at the bottom of this page, post a notification
        on the main page of the Website. We may also provide notice to you in
